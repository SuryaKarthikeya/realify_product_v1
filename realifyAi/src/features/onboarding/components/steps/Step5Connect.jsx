...
import DadJokeCard from '@/features/onboarding/components/DadJokeCard';
    ...
    <div className="flex flex-col h-full anim-fade-in relative max-w-3xl mx-auto w-full">
      ...
      <div className="mb-6 text-left">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3.5 bg-gray-800 text-white font-bold rounded-xl hover:bg-gray-600 transition text-[15px] shadow-sm mb-5"
        >
        ...
        {connectStatus === 'idle' && (
          <div className="flex items-center justify-end w-full">
            <button
              ...
              className={`flex items-center justify-center gap-2 px-10 py-3.5 font-bold rounded-xl transition text-[15px] w-full sm:w-auto ${uploadStatus !== 'uploaded' || !identifyResult?.ready || committing
